...
ApplicationWindow {
    ...
    StackView {
        ...
        // Transitions deaktivieren - keine Slide-Animationen
    ...
    function showSidebar(index) {
        // StackView sofort leeren beim Seitenwechsel
        stackView.clear()
    ...
    function loadAbrechnungsseite() {
        // StackView ist bereits leer, direkt neue Seite laden
        stackView.push("Abrechnungsseite.qml", {
    ...
    function loadSelectionCards() {
        ...
        // StackView ist bereits leer, direkt neue Seite laden
        stackView.push("SelectionCards.qml", {
            goHome: function() { goBack(); },
            abrechnungsBackend: abrechnungsBackend,
            datenBackend: datenBackend,
            mitarbeiterBackend: mitarbeiterBackendV2,  // Auf V2 geändert
    ...
    function loadDatenseite() {
        // StackView ist bereits leer, direkt neue Seite laden
        stackView.push("DatenseiteV3.qml")
    }

    function loadMitarbeiterSeite() {
        // StackView ist bereits leer, direkt neue Seite laden
        stackView.push("MitarbeiterSeiteV3Cards.qml")  // Auf V3 Cards geändert
    }

    function loadFahrzeugSeite() {
        // StackView ist bereits leer, direkt neue Seite laden
        stackView.push("FahrzeugSeiteV2Cards.qml", {
            goHome: function() { stackVisible = false; }
        })
    }

    function goBack() {
        // StackView sofort leeren beim Zurückkehren zum Hauptmenü
        stackView.clear()
